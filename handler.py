...
# словарь примеров
HELP_TEXTS = {
    'реши':['5x+12=7', 'Я могу решать уравнения с одной неизвестной x или y.\n' +\
...
def handle_dialog(req, res, user_storage):
    ...
    if process.first_word == 'помощь':
        res.set_text('Я понимаю команды: ' + ', '.join(HELP_TEXTS) + ', дополненные алгебраическим выражением.\n'+ \
        'Для примеров скажите: Пример и команду. Для подробной инструкции скажите Инструкция.\n'+\
    ...
    if process.first_word == 'помощь':
        ...
        if len(s) == 1
            user_answer = 'Я умею решать уравнения с одной неизвестной x или y, упрощать и вычислять алгебраические выражения.\n'+\
