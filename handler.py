...
# словарь примеров
HELP_TEXTS = {
    'реши':['5x+12=7', 'Командой реши я решаю уравнение с одной неизвестной x или y.'],
    'вычисли':['2^5*sqrt(16)', 'Командой вычисли я считаю числовое значение выражения.'],
    'упрости':['(2x-3y)(3y-2x)-12xy', 'Командой упрости я пытаюсь упростить запись выражения.'],
    'разложи':['x**2 + 4xy + 4y**2', 'Командой разложи я пытаюсь разложить выражение на множители.'],
}
...
def handle_dialog(req, res, user_storage):
    ...
    if process.first_word == 'пример':
        ...
        if len(s) == 1 or s[1] not in HELP_TEXTS:
            ...
            user_answer = s[1]+' '+HELP_TEXTS[s[1]][0]+'\n'+HELP_TEXTS[s[1]][1]
